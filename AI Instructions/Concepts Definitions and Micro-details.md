...
1. Micro-inteligência:
    - Versão atômica da inteligência, a parte de cuida de uma função ou propósito específico, que se falhar pode ocasionar a quebra do propósito ou até da macro-inteligência (vede #Definições 2.) (até porque é feita dela, uma é parte da outra), podem-se existir várias micro-inteligências para se resolver um mesmo problema de uma macro-inteligência.
2. Macro Inteligência: 
    - A inteligência emergente, resultado de micro-inteligências organizadas para um único fim.
